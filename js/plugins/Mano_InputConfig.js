...
function basicSymbols(){
    ...
    const pagedown =createDefaultKeyMapperItem("pagedown",param.mapperPagedown);

    const escapeText = MultiLanguageText.create(param.mapperEscape);
    const escape = new EscapeSymbol(escapeText);
    //return [ok,cancel,shift,menu,escape];
	return [];
}
class EventCaller{
    /**
...
class Gamepad extends InputDeviceBase{
    constructor(){
        ...
        const moves =[
			...
			new GamepadButton(12,"\\I[348]"),
            new GamepadButton(13,"\\I[349]"),
            new GamepadButton(14,"\\I[346]"),
            new GamepadButton(15,"\\I[347]")
        ];
        this._moves =moves;
        const buttons =[
            //new GamepadButton(0,"A/○"),
			new GamepadButton(0,"XB:\\I[363] PS:\\I[367]"),
            new GamepadButton(1,"XB:\\I[364] PS:\\I[365]"),
            new GamepadButton(2,"XB:\\I[365] PS:\\I[350]"),
            new GamepadButton(3,"XB:\\I[366] PS:\\I[351]"),
            new GamepadButton(4,"\\I[381]\\I[382]"),
            new GamepadButton(5,"\\I[287]\\I[382]"),
            new GamepadButton(6,"\\I[381]\\I[383]"),
            new GamepadButton(7,"\\I[287]\\I[383]"),
            new GamepadButton(8,"\\I[285]"),
            new GamepadButton(9,"\\I[286]"),
            new GamepadButton(10,"\\I[381]\\I[319]"),
            new GamepadButton(11,"\\I[287]\\I[319]")
...
class Window_KeyConfig_MA extends Window_InputConfigBase {
    ...
    resetFontSettings(){
        ...
        this.contents.fontSize = $gameSystem.mainFontSize(); //this.lineHeight()-2;
        this.resetTextColor();
    }
    setWASD_Move(){
